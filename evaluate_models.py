...
def measure_inference_speed(weights_path: Path, test_images: list[Path], imgsz: int) -> dict[str, float]:
...
def evaluate_model(weights_path: Path, config: PipelineConfig, model_name: str | None = None) -> dict[str, Any]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, help="Specific model weights to evaluate. If omitted, evaluates all in models dir.")
